...
let insertMenuPart = (jsonObj, dom) => {
    ...
    let menu = `
                ...
                <input type="button" id="buttonSave" class="buttonMenu buttonMenuSave" value="Salva" style="visibility: hidden;"></input>
                <input type="button" id="buttonRecap" class="buttonMenu buttonMenuRecap" value="Sunto" style="visibility: hidden;"></input>
               `;
