...
const resultScript = {
    ...
    scriptRule : (partHtml, type) => {
        ...
        console.log("partHtml %s", partHtml);
        console.log("partHtml.rule %s", partHtml.rule);
        let arrayRule = partHtml.rule.split("|");
        console.log("arrayRule %s", arrayRule);
        arrayRule.forEach(rule => {

            if (rule.split(" ")[0] === type) {

                if (type === "mandatory") {
                    partHtml.rule = rule; // Only 'mandatory' part as rule in parameter object partHtml.
                    ...
                    partHtml.rule = rule; // Only 'visible' part as rule in parameter object partHtml.
...
class GenericScript {
    ...
    buildCondition() {
        ...
        */
        ...
        // console.log("rulePlaceholder> %s", rulePlaceholder);
        ...
        // console.log("arResult> %s", arResult);
