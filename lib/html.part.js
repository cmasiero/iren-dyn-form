...
class GenericHtml {
    ...
    constructor(objParam, clazz){
        ...
        this.editCard = objParam.editCard;
        ...
        this.editCardTag = this.editCard !== undefined ? `editCard="${this.editCard}"` : "";
...
class TextHtml extends GenericHtml {
    ...
    buildPart(){
        ...
        <input type="text" ${this.sizeTag} ${this.maxlengthTag} ${this.joinTag} ${this.editCardTag} id="${this.id}" value="${this.value}">
                      `;
        return result;
    }
}
...
class TextAreaHtml extends GenericHtml {
    ...
    buildPart(){
        let result = `
        <label for="${this.id}">${this.label}</label>
        <textarea ${this.rowsTag} ${this.colsTag} ${this.maxlengthTag} ${this.joinTag} ${this.editCardTag} id="${this.id}" value="${this.value}"></textarea>
                      `;
        return result;
    }
...
class CheckboxHtml extends GenericHtml {
    ...
    buildPart(){
        let result = `
        <input type="checkbox" ${this.joinTag} ${this.editCardTag} id="${this.id}" name="${this.id}" value="${this.value}" ${this.valuemapTag} ${this.checked}>
        <label for="${this.id}">${this.label}</label>
                      `;
        return result;
    }
...
class RadioHtml extends GenericHtml {
    ...
    buildPart(){
        ...
        this.option.forEach(opt => {
            ...
            result += `
            <input type="radio" ${this.joinTag} ${this.editCardTag} id="${opt.value}" ${valuemapTag} name="${this.id}" value="${opt.value}" ${checked}>
...
class SelectHtml extends GenericHtml {
    ...
    buildPart(){
        let result = `
        <label for="${this.id}">${this.label}</label>
        <select name="${this.id}" ${this.joinTag} ${this.editCardTag} id="${this.id}">
                     `;
        this.option.forEach(opt => {
...
class DateHtml extends GenericHtml {
    ...
    buildPart(){
        let result = `
                     <label for="${this.id}">${this.label}</label>
                     <input type="date" ${this.joinTag} ${this.editCardTag} id="${this.id}" value="${this.value}">
                     `;
        return result;
    }
}
